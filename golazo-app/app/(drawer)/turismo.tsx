    ...
    <ScrollView>
      <View className='flex-1 justify-left items-left gap-5 md:p-12 sm:p-8 p-6 bg-secondary/30'>
        <div className="saludo-usuario flex flex-col">
          <p className='text-3xl font-medium mb-1'>Lugares Turísticos</p>
          <p className='text-lg font-normal text-slate-400 m-0'>¡Descubre los lugares turísticos más atractivos en la ciudad!</p>
        </div>

        <div className="linea1 grid md:grid-cols-2 grid-cols-1 w-full gap-4">
          <Card className=''>
            <CardHeader>
              <CardTitle>Nombre del Lugar</CardTitle>
